...
class AnotherAccessories extends StatelessWidget {
  accessoriespack(BuildContext context, int index) {
    AccessoriesStyle style = accessoriesstyles[index];
    return Stack(
                ...
                child: GestureDetector(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index){
                        return accessoriespack(context, index);
                      }
                  ),
                ),
              ),
